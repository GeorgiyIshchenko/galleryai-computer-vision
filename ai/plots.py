...
def people():
   ...
   ax = plt.subplot(1, 1, 1)
   np.random.seed(123)
   groups = ["<100", "100-500", "500-1000", "1000-2000", "2000-3000", "3000-5000", ">5000"]
   counts = [12, 10, 22, 25, 20, 22, 95]
   plt.bar(groups, counts, color = (208/256, 60/256, 45/256), label = "количество фотографий на телефоне")
   ax.set_xlabel("Количество фото", fontsize=15)
   ax.set_ylabel("Количество людей", fontsize=15)
   fig.savefig("диаграмма.jpg")
   plt.show()
